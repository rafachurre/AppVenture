...
export class RegisterPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public toastCtrl: ToastController, private storage: Storage, private cloudDataMngr: CloudDataManagerProvider) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad RegisterPage');
    this.cloudDataMngr.downloadAllGuests();
  }
  ...
  onSavePressed(){
    ...
    let newRegistration = {accommodationID, firstName, lastName, sex, dateOfBirth, country, idNumber, idType, idDateOfIssue, registrationDate, signedDate, submittedDate, status}
